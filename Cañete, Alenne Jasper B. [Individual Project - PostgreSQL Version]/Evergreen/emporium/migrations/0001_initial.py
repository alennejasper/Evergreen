# Generated by Django 4.1.7 on 2023-06-10 05:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields = [
                ...
                ("purchase_date", models.DateTimeField(default = datetime.datetime(2023, 6, 10, 13, 57, 0, 529833), verbose_name = "Purchase Date")),
            ],
            options = {
                "verbose_name": "Report",
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ("delivery_date", models.DateField(default = datetime.datetime(2023, 6, 13, 13, 57, 0, 529833), verbose_name = "Delivery Date")),
            ],
            options = {
        ...
        migrations.CreateModel(
            ...
            fields = [
                ("id", models.BigAutoField(auto_created = True, primary_key = True, serialize = False, verbose_name = "ID")),
                ("order_date", models.DateTimeField(default = datetime.datetime(2023, 6, 10, 13, 57, 0, 528836), verbose_name = "Order Date")),
                ("order_completion", models.BooleanField(blank = True, default = True, null = True, verbose_name = "Order Completion")),
                ("order_voucher", models.CharField(default = 1686376620.528836, max_length = 20, null = True, verbose_name = "Order Voucher")),
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ("barangay_name", models.CharField(max_length = 50, null = True, verbose_name = "Barangay Name")),
                ("municipality_name", models.CharField(max_length = 50, null = True, verbose_name = "Municipality Name")),
                ("delivery_date", models.DateField(default = datetime.datetime(2023, 6, 13, 13, 57, 0, 527839), verbose_name = "Delivery Date")),
            ],
            options = {
                "verbose_name": "Delivery",
                "verbose_name_plural": "Deliveries",
        ...
        migrations.CreateModel(
            ...
            fields = [
                ("id", models.BigAutoField(auto_created = True, primary_key = True, serialize=False, verbose_name = "ID")),
                ("order_date", models.DateTimeField(default = datetime.datetime(2023, 6, 10, 13, 57, 0, 526841), verbose_name = "Order Date")),
                ("order_completion", models.BooleanField(blank = True, default = True, null = True, verbose_name = "Order Completion")),
                ("order_voucher", models.CharField(default=1686376620.526841, max_length = 20, null = True, verbose_name = "Order Voucher")),
                ("order_status", models.CharField(blank = True, choices = [("Processed", "Processed"), ("Shipped", "Shipped"), ("Delivered", "Delivered"), ("Failed", "Failed")], default = "Processed", max_length = 20, null = True, verbose_name = "Order Status")),
        ...
        migrations.CreateModel(
            ...
            fields = [
                ("id", models.BigAutoField(auto_created = True, primary_key = True, serialize = False, verbose_name = "ID")),
                ("purchase_amount", models.IntegerField(blank = True, default = 0, null = True, verbose_name = "Purchase Amount")),
                ("purchase_date", models.DateTimeField(default = datetime.datetime(2023, 6, 10, 13, 57, 0, 527839), verbose_name = "Purchase Date")),
