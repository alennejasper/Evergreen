    ...
    operations = [
        migrations.CreateModel(
            ...
            fields = [
                ...
                ("purchase_date", models.DateTimeField(default = datetime.datetime(2023, 3, 3, 21, 24, 24, 891880), verbose_name = "Purchase Date")),
            ],
            options = {
                "verbose_name": "Report",
        ...
        migrations.CreateModel(
            ...
            fields = [
                ("id", models.BigAutoField(auto_created = True, primary_key = True, serialize = False, verbose_name = "ID")),
                ("order_date", models.DateTimeField(default = datetime.datetime(2023, 3, 3, 21, 24, 24, 891880), verbose_name = "Order Date")),
                ("order_completion", models.BooleanField(blank = True, default = True, null = True, verbose_name = "Order Completion")),
                ("order_voucher", models.CharField(default = 1677849864.89188, max_length = 20, null = True, verbose_name = "Order Voucher")),
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ("delivery_date", models.DateField(default = datetime.datetime(2023, 3, 6, 21, 24, 24, 890883), verbose_name = "Delivery Date")),
            ],
            options = {
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ("item_quantity", models.IntegerField(blank = True, default = 0, null = True, verbose_name = "Item Amount")),
        ...
        migrations.CreateModel(
            ...
            fields = [
                ("id", models.BigAutoField(auto_created = True, primary_key = True, serialize = False, verbose_name = "ID")),
                ("order_date", models.DateTimeField(default = datetime.datetime(2023, 3, 3, 21, 24, 24, 889886), verbose_name = "Order Date")),
                ("order_completion", models.BooleanField(blank = True, default = True, null = True, verbose_name = "Order Completion")),
                ("order_voucher", models.CharField(default = 1677849864.889886, max_length = 20, null = True, verbose_name = "Order Voucher")),
                ("order_status", models.CharField(blank = True, choices = [("Processed", "Processed"), ("Shipped", "Shipped"), ("Delivered", "Delivered"), ("Failed", "Failed")], default = "Processed", max_length = 20, null = True, verbose_name = "Order Status")),
                ("persona", models.ForeignKey(blank = True, null = True, on_delete = django.db.models.deletion.SET_NULL, to = "emporium.persona", verbose_name = "Persona")),
            ],
            options = {
        ...
        migrations.CreateModel(
            ...
            fields = [
                ("id", models.BigAutoField(auto_created = True, primary_key = True, serialize = False, verbose_name = "ID")),
                ("purchase_amount", models.IntegerField(blank = True, default = 0, null = True, verbose_name = "Purchase Amount")),
                ("purchase_date", models.DateTimeField(default = datetime.datetime(2023, 3, 3, 21, 24, 24, 889886), verbose_name = "Purchase Date")),
        ...
        migrations.AddField(
            model_name = "delivery",
            name = "persona",
            field = models.ForeignKey(blank = True, null = True, on_delete = django.db.models.deletion.SET_NULL, to = "emporium.persona", verbose_name = "Persona"),
        ),
        migrations.AddField(
            model_name = "delivery",
            name = "purchase",
        ...
        migrations.AddIndex(
            model_name = "persona",
            index = models.Index(fields = ["user_name"], name = "emporium_pe_user_na_4c4f6c_idx"),
        ),
        migrations.AddIndex(
            model_name = "delivery",
