# Generated by Django 4.1.7 on 2023-05-19 12:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_date', models.DateTimeField(default=datetime.datetime(2023, 5, 19, 20, 58, 35, 137368), verbose_name='Purchase Date')),
            ],
            options={
                'verbose_name': 'Report',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_date', models.DateTimeField(default=datetime.datetime(2023, 5, 19, 20, 58, 35, 136371), verbose_name='Order Date')),
                ('order_completion', models.BooleanField(blank=True, default=True, null=True, verbose_name='Order Completion')),
                ('order_voucher', models.CharField(default=1684501115.136371, max_length=20, null=True, verbose_name='Order Voucher')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_date', models.DateField(default=datetime.datetime(2023, 5, 22, 20, 58, 35, 135374), verbose_name='Delivery Date')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_date', models.DateTimeField(default=datetime.datetime(2023, 5, 19, 20, 58, 35, 134376), verbose_name='Order Date')),
                ('order_completion', models.BooleanField(blank=True, default=True, null=True, verbose_name='Order Completion')),
                ('order_voucher', models.CharField(default=1684501115.134376, max_length=20, null=True, verbose_name='Order Voucher')),
                ('order_status', models.CharField(blank=True, choices=[('Processed', 'Processed'), ('Shipped', 'Shipped'), ('Delivered', 'Delivered'), ('Failed', 'Failed')], default='Processed', max_length=20, null=True, verbose_name='Order Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('purchase_amount', models.IntegerField(blank=True, default=0, null=True, verbose_name='Purchase Amount')),
                ('purchase_date', models.DateTimeField(default=datetime.datetime(2023, 5, 19, 20, 58, 35, 135374), verbose_name='Purchase Date')),
