    ...
    operations = [
        migrations.CreateModel(
            ...
            fields = [
                ...
                ("purchase_date", models.DateTimeField(default = datetime.datetime(2023, 3, 3, 20, 50, 37, 437343), verbose_name = "Purchase Date")),
            ],
            options = {
                "verbose_name": "Report",
        ...
        migrations.CreateModel(
            ...
            fields = [
                ("id", models.BigAutoField(auto_created = True, primary_key = True, serialize = False, verbose_name = "ID")),
                ("order_date", models.DateTimeField(default = datetime.datetime(2023, 3, 3, 20, 50, 37, 437343), verbose_name = "Order Date")),
                ("order_completion", models.BooleanField(blank = True, default = True, null = True, verbose_name = "Order Completion")),
                ("order_voucher", models.CharField(default = 1677847837.437343, max_length = 20, null = True, verbose_name = "Order Voucher")),
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ("delivery_date", models.DateField(default = datetime.datetime(2023, 3, 6, 20, 50, 37, 436346), verbose_name = "Delivery Date")),
            ],
            options = {
        ...
        migrations.CreateModel(
            ...
            fields = [
                ("id", models.BigAutoField(auto_created = True, primary_key = True, serialize = False, verbose_name = "ID")),
                ("order_date", models.DateTimeField(default = datetime.datetime(2023, 3, 3, 20, 50, 37, 435350), verbose_name = "Order Date")),
                ("order_completion", models.BooleanField(blank = True, default = True, null = True, verbose_name = "Order Completion")),
                ("order_voucher", models.CharField(default = 1677847837.43535, max_length = 20, null = True, verbose_name = "Order Voucher")),
                ("order_status", models.CharField(blank = True, choices = [("Processed", "Processed"), ("Shipped", "Shipped"), ("Delivered", "Delivered"), ("Failed", "Failed")], default = "Processed", max_length = 20, null = True, verbose_name = "Order Status")),
        ...
        migrations.CreateModel(
            ...
            fields = [
                ("id", models.BigAutoField(auto_created = True, primary_key = True, serialize = False, verbose_name = "ID")),
                ("purchase_amount", models.IntegerField(blank = True, default = 0, null = True, verbose_name = "Purchase Amount")),
                ("purchase_date", models.DateTimeField(default = datetime.datetime(2023, 3, 3, 20, 50, 37, 435350), verbose_name = "Purchase Date")),
