    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_date', models.DateTimeField(default=datetime.datetime(2023, 5, 19, 22, 23, 27, 568629), verbose_name='Purchase Date')),
            ],
            options={
                'verbose_name': 'Report',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_date', models.DateTimeField(default=datetime.datetime(2023, 5, 19, 22, 23, 27, 568629), verbose_name='Order Date')),
                ('order_completion', models.BooleanField(blank=True, default=True, null=True, verbose_name='Order Completion')),
                ('order_voucher', models.CharField(default=1684506207.568629, max_length=20, null=True, verbose_name='Order Voucher')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_date', models.DateField(default=datetime.datetime(2023, 5, 22, 22, 23, 27, 568629), verbose_name='Delivery Date')),
            ],
            options={
